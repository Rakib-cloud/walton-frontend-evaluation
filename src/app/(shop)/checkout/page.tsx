      ...
      <form onSubmit={handlePlaceOrder} className="grid gap-8 lg:grid-cols-3 lg:items-start">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-xs lg:col-span-1 space-y-6">
          ...
          <button
            ...
            className="w-full flex h-12 items-center justify-center rounded-xl bg-walton-blue text-sm font-bold text-white transition-all hover:bg-walton-teal shadow-xs hover:shadow-md active:scale-99 disabled:cursor-not-allowed disabled:opacity-70"
          >
