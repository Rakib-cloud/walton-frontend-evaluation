                    ...
                    <div className="flex items-center gap-3 mt-3 sm:mt-0">
                      <div className="flex items-center rounded-lg border border-zinc-300 bg-zinc-55">
                        <button
                          ...
                          className="h-8 w-8 flex items-center justify-center text-zinc-600 hover:text-zinc-950 font-medium transition-colors"
                      ...
                      <button
                        ...
                        className="p-1.5 text-zinc-400 hover:text-red-600 transition-colors rounded-md hover:bg-zinc-50"
